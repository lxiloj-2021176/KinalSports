// client-user/src/features/tournaments/screens/MyTournaments.jsx
  ...
  return (
    <View style={styles.container}>
      <FlatList
        ...
        refreshControl={
          <RefreshControl refreshing={loading} onRefresh={refetchMyTournaments} tintColor={COLORS.primary} />
        }
        ListEmptyComponent={
          !loading ? (
