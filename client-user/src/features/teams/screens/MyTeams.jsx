// client-user/src/features/teams/screens/MyTeams.jsx
    ...
    >
      <Card style={styles.card}>
        ...
        <View style={styles.content}>
          ...
          {item.captain && <Text style={styles.captain}>Capitán: {item.captain?.name || 'N/A'}</Text>}
        </View>
      </Card>
    </TouchableOpacity>
  );
  ...
  return (
    <View style={styles.container}>
      <FlatList
        ...
        refreshControl={
          <RefreshControl refreshing={loading} onRefresh={refetchMyTeams} tintColor={COLORS.primary} />
        }
        ListEmptyComponent={
          !loading ? (
